...
- 2M target < 200 ms GPU: met (87–93 ms over 3 runs). First-ever build after a reload includes pipeline compile (Task 5: normals 56.75, ao 36.70, wall 208 ms; Task 4 hash-only: 181.8 ms cold → 20.1 ms warm).
